      ...
      <div className="bg-Yellow w-full ml-[10px] mr-[10px] rounded-md p-2 pl-[50px] pr-[50px] rounded-md">
        ...
        {inProgress && (
          ...
          <div className="flex h-full">
            <img
              src={assigned1}
              className="h-[150px] w-[25%] rounded-md mr-[10px]"
            />
            <div>
          ...
          <div className="flex h-full">
            ...
            <div>
              ...
              <div className="flex space-x-6 mt-[10px]">
                ...
                <p>65%</p> */}
                <button className="ring-2 ring-Yellow text-Darkblue text-lg font-semibold bg-Yellow rounded-md w-[25%] flex items-center justify-center">Certificate <FaDownload /></button>
              </div>
            </div>
          </div>
        </div>
